...
# URL binary
BINARY_URL="https://sh.lokio.dev/bin/lokio"
# URL untuk data yang ingin diunduh
DATA_URL="https://sh.lokio.dev/data/info.md"
DATA_DEST="$HOME/.local/share/lokio/info.md" # Lokasi penyimpanan data
...
do_user_install() {
    ...
    # Menambahkan data ke direktori yang sesuai
    mkdir -p "$HOME/.local/share/lokio"
    curl -# -o "$DATA_DEST" "$DATA_URL"
